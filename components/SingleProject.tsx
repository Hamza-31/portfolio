			...
			<div className="group relative grid gap-4 pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
				...
				<div className="z-10 sm:order-2 sm:col-span-6">
					...
					<ul className="mt-2 flex flex-wrap">
						{project.stacks.map((stack: string | null | undefined) => (
				...
				<Image src={getImage(project.src) as any} alt="" className="rounded border-2 border-slate-200/10 transition group-hover:border-slate-200/30 sm:order-1 sm:col-span-2 sm:translate-y-1" />
			</div>
		</li>
	)
}
